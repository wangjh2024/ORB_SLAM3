...
#  undef access
#endif
#include <boost/serialization/access.hpp>  // Ω®“Èœ‘ Ω∞¸∫¨
...
#include <boost/serialization/access.hpp>  // Ê∑ªÂä†ËøôË??
#include <boost/serialization/serialization.hpp>  // Âè?ËÉΩ‰πüÈúÄË¶ÅËøôË°?
